        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-all">
            <div className="text-center mb-6">
              <h2 className="text-xl font-bold text-gray-800 mb-2">مجاني</h2>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li className="flex items-center gap-2 text-gray-400">
                ...
                <span>طلبات من الموقع</span>
              </li>
              <li className="flex items-center gap-2 text-gray-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
                <span>طلبات الطاولات</span>
              </li>
              <li className="flex items-center gap-2 text-gray-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            ...
            <a
              ...
              className="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-800 py-3 rounded-xl font-bold transition"
            >
          ...
          {/* Pro Plan */}
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-cyan-500 hover:shadow-xl transition-all relative">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
              <span className="bg-cyan-500 text-white px-4 py-1 rounded-full text-sm font-bold">الأكثر شيوعاً</span>
            </div>

            <div className="text-center mb-6 mt-2">
              <h2 className="text-xl font-bold text-gray-800 mb-2">احترافي</h2>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li className="flex items-center gap-2 text-gray-600">
                ...
                <span>إدارة العاملين (حتى 5)</span>
              </li>
            </ul>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full text-center bg-gradient-to-r from-teal-400 via-cyan-500 to-cyan-500 hover:from-teal-500 hover:via-cyan-600 hover:to-cyan-600 text-white py-3 rounded-xl font-bold transition"
            >
              للاستفسار تواصل معنا
            </a>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-all">
            <div className="text-center mb-6">
              <h2 className="text-xl font-bold text-gray-800 mb-2">الأعمال</h2>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li className="flex items-center gap-2 text-gray-600">
                ...
                <span>عاملين غير محدودين</span>
              </li>
              <li className="flex items-center gap-2 text-gray-600">
                <svg className="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>إنشاء إعلانات</span>
              </li>
              <li className="flex items-center gap-2 text-gray-600">
                <svg className="w-5 h-5 text-cyan-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full text-center bg-gray-800 hover:bg-gray-900 text-white py-3 rounded-xl font-bold transition"
            >
              للاستفسار تواصل معنا
            </a>
          </div>
