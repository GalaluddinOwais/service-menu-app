  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-teal-50 via-cyan-50 to-cyan-50" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className={`grid md:grid-cols-2 gap-6 ${isUpgradeMode ? 'lg:grid-cols-3' : 'lg:grid-cols-4'}`}>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-all">
              ...
              <ul className="space-y-3 mb-6">
                ...
                <li className="flex items-center gap-2 text-gray-600">
                  ...
                  <span className="text-sm">حتى 15 منتج</span>
                </li>
                <li className="flex items-center gap-2 text-gray-600">
                  <svg className="w-5 h-5 text-cyan-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <li className="flex items-center gap-2 text-gray-400">
                  ...
                  <span className="text-sm">نظام الطاولات والندلاء</span>
                </li>
              </ul>
          ...
          {/* Basic Plan */}
          <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-all relative">
            <div className="text-center mb-6">
          ...
          {/* Pro Plan */}
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-cyan-500 hover:shadow-xl transition-all relative scale-105 z-10">
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-all">
            ...
            <Link
              ...
              className="block w-full text-center bg-gray-900 text-white py-3 rounded-xl font-bold transition text-sm hover:bg-black"
            >
              اشترك الآن            </Link>
          </div>
        </div>
